  ...
  return (
    <div>
      ...
      <div className="video-infra bg-amber-50 w-full h-2/4 mt-40 flex items-center justify-center flex-col">
        ...
        <p className='flex justify-center m-10 gap-8 w-5/6 text-amber-800'><h2 className='text-amber-900 text-3xl font-bold'>Location </h2> Located at the upcoming Industrial Zone Of Chakan Phase II , Near Hyundai and Bridgestone and General Electrical Company
            <h2 className='text-amber-900 text-3xl font-bold'>Factory Constructed area </h2> Buildup 4000+4000 sq-ft Total Size of 16000 sq-ft for further Development.
