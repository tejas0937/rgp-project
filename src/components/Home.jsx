  ...
  return (
    <div>
      ...
      <div className="video-infra bg-amber-50 w-full h-2/4 mt-0 flex items-center justify-center flex-col">
        ...
        <p className='infraloc-info flex justify-center m-10 gap-8 w-5/6 text-amber-800 max-md:m-1'>
        <h2 className='text-amber-900 text-3xl font-bold max-md:border-l-2 max-md:pl-4 max-md:h-11 '>Location </h2> Located at the upcoming Industrial Zone Of Chakan Phase II , Near Hyundai and Bridgestone and General Electrical Company
          <h2 className='text-amber-900 text-3xl font-bold h-26 border-l-2 pl-4 max-md:h-22'>Factory Constructed area </h2> Buildup 4000+4000 sq-ft Total Size of 16000 sq-ft for further Development.
          <h2 className='text-amber-900 text-3xl font-bold mb-30 max-md:mb-0 h-26 max-md:h-12 border-l-2 pl-4'>Power </h2> Well connected Capacity for Electrical Power at plant and Genset as a back up .</p>
        ...
        <h1 className='w-full bg-amber-950 text-5xl/15 text-amber-50  h-80 text-center pt-20
      ...
      <div className="director flex ">
        ...
        <div className="dir-info flex justify-center flex-col">
          <h2 className='ml-15 -mt-10 text-amber-900 max-md:invisible'>About Us</h2>
      ...
      <div className="home-pro flex flex-col w-full  bg-amber-50 items-center py-20 max-md:py-7">
      ...
      <div className="client-info flex w-full h-150 bg-gradient-to-r from-amber-100 to-amber-300 my-40  items-center flex-col shadow-[0_4px_12px_-4px_rgba(0,0,0,0.55)]">
