...
const Home = () => {
  return (
    <div>
      ...
      <div className="video-infra bg-blue-100 w-full h-2/4 mt-0 flex items-center justify-center flex-col">
      ...
      <div className="director flex ">
        ...
        <div className="dir-info flex justify-center flex-col">
          ...
          <Link to="/about">
            <button
              className='text-blue-950 bg-white w-60 cursor-pointer mt-6 ml-15 p-5 text-2xl font-bold rounded-2xl transition duration-200 ease-in-out hover:bg-blue-950 hover:text-white hover:shadow-lg'
            >
              View More Info
            </button>
          </Link>
      ...
      <div className="join-info flex w-full h-150 bg-blue-100 my-40 shadow-[0_4px_12px_-4px_rgba(0,0,0,0.55)]">
      ...
      <div className="home-pro flex flex-col w-full  bg-blue-100 items-center py-20 max-md:py-7">
        ...
        <Link to="/products#corrugated" className="hp-ind"><div className='flex flex-col items-center' >
          ...
          <h1> Corrogated Packaging</h1> <p className='bg-blue-100 w-50 p-1 m-2 rounded text-blue-900 border-1 border-black'>View Products</p>
        </div></Link>
        <Link to="/products#wooden"className="hp-ind"><div className='flex flex-col items-center' >
          ...
          <h1> Wooden <br></br>Packaging</h1><p className='bg-blue-100 w-50 p-1 m-2 rounded text-blue-900 border-1 border-black'>View Products</p>
        </div></Link>
        <Link to="/products#protective" className="hp-ind "><div className='flex flex-col items-center'>
          ...
          <h1> Protective Accessories</h1><p className='bg-blue-100 w-50 p-1 m-2 rounded text-blue-900 border-1 border-black'>View Products</p>
        </div></Link>
        <Link to="/products#custom"className="hp-ind "><div  className='flex flex-col items-center'>
          ...
          <h1> Custom Packaging Solutions</h1><p className='bg-blue-100 w-50 p-1 m-2 rounded text-blue-900 border-1 border-black'>View Products</p>
        </div></Link>
        <Link to="/products#our-work"className="hp-ind "><div className='flex flex-col items-center' >
          ...
          <h1> View Our Recent Work</h1><p className='bg-blue-100 w-50 p-1 m-2 rounded text-blue-900 border-1 border-black'>View Recent Work</p>
        </div></Link></div>
      </div>
      ...
      <div className="client-info flex w-full h-150 bg-gradient-to-r from-blue-100 to-blue-200 my-40  items-center flex-col shadow-[0_4px_12px_-4px_rgba(0,0,0,0.55)]">
        <h1 className='text-6xl font-bold text-blue-950 text-center w-7/8 my-20 border-b-blue -950 border-b-2 pb-10'>Our Clients</h1>
