  ...
  return (
    <div className='about'>
      ...
      <div className="vision-board flex">
        <img src="/plant/bg-m1.webp" alt="RGP Pack Tech Solution manufacturing plant background" />
    ...
    >
      ...
      <div className="director flex ">
        <div className="team-img max-md:ml-10">
          <img src="/plant/team-rgp..webp" alt="RGP Pack Tech Solution team members working together" />
