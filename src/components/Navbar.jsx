                ...
                <ul className='justify-start items-center gap-15 text-lg mr-16 hidden lg:flex navg'>
                    ...
                    <li>
                        <select
                            ...
                            defaultValue=""
                        >
                            <option value="/products#allproduct" style={{ color: window.location.hash === '#allproduct' ? '#964B00' : undefined, fontWeight: window.location.hash === '#allproduct' ? 'bold' : undefined }}>Products</option>
                ...
                <ul className='uppercase p-4 flex flex-col font-semibold  navl'>
                    ...
                    <li className=' border-b p-2 flex justify-center'>
                        <select
                            ...
                            style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', color: window.location.hash === '#allproduct' || window.location.hash === '#corrugated' || window.location.hash === '#wooden' || window.location.hash === '#protective' || window.location.hash === '#custom' ? '#964B00' : undefined }}
                            onChange={handleProductChange}
                            defaultValue=""
                        >
                            <option value="/products#allproduct" style={{ color: window.location.hash === '#allproduct' ? '#964B00' : undefined }} onClick={() => setNav(false)}>Products</option>
